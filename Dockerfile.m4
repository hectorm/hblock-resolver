...
# Build LuaJIT
ARG LUAJIT_TREEISH=871db2c84ecefd70a850e03a6c340214a81739f0
...
ENV KRESD_DNS_ENABLED=true
ENV KRESD_DOT_ENABLED=true
ENV KRESD_DOH_ENABLED=true
ENV KRESD_WEB_ENABLED=true
